...
tt = pd.read_csv("features_prediction_1979.csv")
#tt = tt[tt.cluster <= 27360]
##tt = tt.tail(100)
yrs = tt["year"].unique()
#print(yrs)
...
for i in yrs:
    ...
    ###mean impute
    test_temp = match(proba, tt[tt.year == i], i)
    test_final = test_final.append(test_temp, ignore_index= True)
    
test_final.to_csv("feature_1979.csv", index = False)
