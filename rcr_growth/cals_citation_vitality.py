...
occ_y['referenced_year'] = y - occ_y['referenced_year']
occ_y['referenced_year'] = 1 / (1 + occ_y['referenced_year'])

tmp = occ_y[occ_y.referenced == 34141351]
print(tmp['referenced_year'].sum())
print(occ_y.tail(5))
...
result2['referenced_year'] = result2['referenced_year']/result2['citation_count']
...
##we need to divide it by n and power (1/4)
